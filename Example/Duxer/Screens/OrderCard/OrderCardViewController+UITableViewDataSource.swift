//
//  OrderCardViewController+UITableViewDataSource.swift
//  DuxerExample
//
...
extension OrderCardViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case let .options(options):
            ...
            let segmentCell = tableView.dequeueReusableCell(
                with: SegmentCell.Item(
                    item: .init(
                        items: options.map(\.title),
