//
//  RegistrationViewController+UITableViewDataSource.swift
//  DuxerExample
//
...
extension RegistrationViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case let .date(item):
            let dateCell = tableView.dequeueReusableCell(
                with: DatePickerCell.Item(
                    item: item,
            ...
            dateCell.child.addTarget(self, action: #selector(self.datePickerValueChanged), for: .valueChanged)
